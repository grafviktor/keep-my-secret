export default ({ width = 72, height = 72 }) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <path d="M9 8C6.23858 8 4 10.2386 4 13V17C4 19.7614 6.23858 22 9 22H15C17.7614 22 20 19.7614 20 17V13C20 10.2386 17.7614 8 15 8H9Z" fill="#6610f2" />
